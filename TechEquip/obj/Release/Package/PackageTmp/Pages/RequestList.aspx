<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequestList.aspx.cs" Inherits="TechEquip.Pages.RequestList" EnableEventValidation="false"%>
...
<body>
    <form id="form1" runat="server">
        <nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-primary">
            ...
            <div class="collapse navbar-collapse" id="navbarmenu">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="EquipList.aspx">Список оборудования</a>
                    </li>
                    <li class="nav-item  active">
                        <a class="nav-link" href="RequestList.aspx">Список заявок<span class="sr-only">(current)</span></a>
                    </li>
                </ul>
            </div>
        ...
        <asp:SqlDataSource ID="sdsRequestList" runat="server"></asp:SqlDataSource>
        ...
        <div class="row justify-content-center">
            ...
            <div class="container col-11">
                <div class="Table mt-3 scrbar" style="max-height: 490px; overflow-y: auto; -webkit-overflow-scrolling: touch;">
                    <asp:GridView ID="gvRequestList" runat="server" Class="table table-dark table-condensed table-hover" AllowSorting="true" UseAccessibleHeader="true" CurrentSortDirection="ASC"
                        Font-Size="20px" AlternatingRowStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center"
                        OnRowDataBound="gvRequestList_RowDataBound" OnSelectedIndexChanged="gvRequestList_SelectedIndexChanged" OnSorting="gvRequestList_Sorting" OnRowDeleting="gvRequestList_RowDeleting">
                        <Columns>
            ...
            <div class="container" >
                <div class="row col-12 align-items-end" style="margin-right: 0px; margin-left: 0px;" >
                    <div class="form-group col-md-4 btdw albt">
                        <label class="lblText">Стоимость ремонта</label>
                        <div class="input-container">
                            <asp:TextBox ID="tbRepairCost" class="form-control" Style="border-radius: 10px 0 0 10px;" runat="server" placeholder="0" type="search" TextMode="Number" MaxLength="10"></asp:TextBox>
                            <i class="fa fa-rub icon" aria-hidden="true"></i>
                        </div>
                        <asp:RequiredFieldValidator ID="RequiredRepairCostr" runat="server" ErrorMessage="Укажите стоимость ремонта" ControlToValidate="tbRepairCost"
                        CssClass="Error" Display="Dynamic"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RegularRepairCost" ControlToValidate="tbRepairCost" ValidationExpression="^[0-9\,]+$"
                        ErrorMessage="Некорректный ввод символов" Display="Dynamic" CssClass="Error" EnableClientScript="true" runat="server" />
                    </div>
                    <div class="form-group col-md-4 btdw albt">
                        <label class="lblText">Сервисная организация</label>
                        <asp:TextBox ID="tbServiceOrg" class="form-control" type="search" runat="server" MaxLength="50"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredServiceOrg" runat="server" ErrorMessage="Укажите наименование" ControlToValidate="tbServiceOrg"
                        CssClass="Error" Display="Dynamic"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RegularServiceOrg" ControlToValidate="tbServiceOrg" ValidationExpression="^[а-яА-ЯёЁa-zA-Z0-9\ ]+$"
                        ErrorMessage="Некорректный ввод символов" Display="Dynamic" CssClass="Error" EnableClientScript="true" runat="server" />
                    </div>
                    <div class="form-group col-md-4 btup albt" >
                        <asp:Button ID="btUpdate" class="btn btn-primary btn-block btn-lg tooltips" OnClick="btUpdate_Click" runat="server" Text="Закрыть заявку" data-placement="bottom" title="Выберете поле из таблицы перед записью" />
                    </div>
                </div>
            </div>
