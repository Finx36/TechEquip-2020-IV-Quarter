<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="TechEquip.Pages.Admin.Users" EnableEventValidation="false"%>
        ...
        <div class="collapse navbar-collapse" id="navbarmenu">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
              <li class="nav-item active">
                <a class="nav-link" href="Users.aspx">Пользователи<span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                ...
                <div class="container col-11">
                    <div class="Table mt-4 scrbar" style="max-height: 490px; overflow: auto;  -webkit-overflow-scrolling: touch;">
                        <asp:GridView ID="gvUsers" runat="server" Class="table table-dark table-condensed table-hover" AllowSorting="true" UseAccessibleHeader="true" CurrentSortDirection="ASC"
                            Font-Size="20px" AlternatingRowStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center"
                            OnRowDataBound="gvUsers_RowDataBound" OnSelectedIndexChanged="gvUsers_SelectedIndexChanged" OnSorting="gvUsers_Sorting" OnRowDeleting="gvUsers_RowDeleting">
                            <Columns>
                ...
                <div class="container">
                    <div class="row justify-content-center align-items-end col-12 col-xs-10 col-sm-10 col-md-10 col-lg-8" style="margin-left: 0px; margin-right: 0px;">
                        <div class="form-group col-12 col-md-6 col-lg-6">
                            <label class="lblText">Должность</label>
                            <asp:DropDownList class="form-control" ID="ddlPosition" runat="server"></asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredBranchers" runat="server" ErrorMessage="Поле не должно быть пустым" class="Error" ControlToValidate="ddlPosition" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                        </div>
                        <div class="form-group col-12 col-md-6 col-lg-6">
