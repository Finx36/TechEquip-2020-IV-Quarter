<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Position.aspx.cs" Inherits="TechEquip.Pages.Admin.Position" EnableEventValidation="false"%>
        ...
        <div class="collapse navbar-collapse" id="navbarmenu">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="Position.aspx">Должности<span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
            ...
            <div class="row justify-content-center">
                ...
                <div class="form-row justify-content-center col-12">
                    <div class="Table col-lg-6 col-10 mt-4 scrbar" style="max-height:490px;overflow-y:auto; -webkit-overflow-scrolling: touch;">
                        <asp:GridView id="gvPosition" runat="server" Class="table table-dark table-condensed table-hover" AllowSorting="true" UseAccessibleHeader="true" CurrentSortDirection="ASC" 
                            Font-Size="20px" AlternatingRowStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" 
                            OnRowDataBound="gvPosition_RowDataBound"  OnSelectedIndexChanged="gvPosition_SelectedIndexChanged" OnSorting="gvPosition_Sorting" OnRowDeleting="gvPosition_RowDeleting" >
                            <Columns>
                    ...
                    <div class="col-sm-8 col-md-6 col-lg-4">
                        <div class="form-group col-lg-12">
                            ...
                            <asp:TextBox ID="tbPosition" class="form-control" runat="server" type="search" MaxLength="50" ></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredPosition" runat="server" ErrorMessage="Поле не должно быть пустым" class="Error" ControlToValidate="tbPosition" display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator id="RegularPosition" ControlToValidate="tbPosition" ValidationExpression="^[а-яА-ЯёЁa-zA-Z]+$" ErrorMessage="Некорректный ввод символов" display="Dynamic" class="Error" EnableClientScript="true"  runat="server"/>
                        </div>
                        <div class="form-group col-lg-12">
