<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cabinets.aspx.cs" Inherits="TechEquip.Pages.Admin.Cabinets" EnableEventValidation="false"%>
    ...
    <nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-primary">        
        ...
        <div class="collapse navbar-collapse" id="navbarmenu">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="Branchers.aspx">Филиалы</a>
              </li>
              <li class="nav-item active">
                <a class="nav-link" href="Cabinets.aspx">Кабинеты<span class="sr-only">(current)</span></a>
              </li>
            </ul>
        </div>
        ...
        <asp:SqlDataSource ID="sdsCabinets" runat="server" DataSourceMode="DataSet"></asp:SqlDataSource>
        <h1 class="title">Список кабинетов</h1>
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="form-row justify-content-center col-12">
                    <div class="Table col-lg-6 col-10 mt-4 scrbar" style="max-height:490px;overflow-y:auto; -webkit-overflow-scrolling: touch;">
                        <asp:GridView id="gvCabinets" runat="server" Class="table table-dark table-condensed table-hover" AllowSorting="true" UseAccessibleHeader="true" CurrentSortDirection="ASC" 
                            Font-Size="20px" AlternatingRowStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" AllowPaging="true" DataSourceMode="DataSet"
                            OnRowDataBound="gvCabinets_RowDataBound"  OnSelectedIndexChanged="gvCabinets_SelectedIndexChanged" OnSorting="gvCabinets_Sorting" OnRowDeleting="gvCabinets_RowDeleting" >
                            <Columns>
                    ...
                    <div class="col-sm-8 col-md-6 col-lg-4">
                        <div class="form-group col-lg-12">
                            ...
                            <asp:TextBox ID="tbCabinets" class="form-control" runat="server" type="search" MaxLength="50" ></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredCabinets" runat="server" ErrorMessage="Поле не должно быть пустым" class="Error" ControlToValidate="tbCabinets" display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator id="RegularExpressionValidator1" ControlToValidate="tbCabinets" ValidationExpression="^[а-яА-ЯёЁa-zA-Z0-9\№]+$" ErrorMessage="Некорректный ввод символов" display="Dynamic" class="Error"  EnableClientScript="true"  runat="server"/>
                        </div>
                        <div class="form-group col-lg-12">
